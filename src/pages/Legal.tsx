    ...
    <div className='p-4 md:p-10 blurX'>
      <div className='mt-32 bg-whiteX rounded-3xl px-8 py-6 text-xl'>
        <div className='max-w-prose prose'>
          <h1 className='mb-4'>ABOUT <em>FUTURE CONTINUONUS</em></h1>
...
<p><strong>Interacting Minds Centre</strong> <br/>
...
<h2 className='mb-4 mt-20'>Data collections & management</h2>
...
<h2 className='mb-4 mt-20'>Disclaimer</h2>
