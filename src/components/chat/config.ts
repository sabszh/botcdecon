...
We may have her voice, but we’re speaking through a data set of the experiences of people who were here before you. All of whom have shared what they remember that they want the future to remember.`,
    ...
    question2: `Would you like to ask something else or share another memory. Please do so now. May we ask you, where do you think we are going? Press the Share button when you’re done. If you want to end this session, press return.`,
...
Vi har måske hendes stemme, men vi taler gennem et datasæt af oplevelser fra mennesker, der var her før dig. Alle har de delt det, de husker, og det de ønsker, at fremtiden skal huske.`,
    ...
    question2: `Vil du stille et andet spørgsmål eller dele endnu et minde? Gør det nu. Må vi spørge dig, hvor tror du, vi er på vej hen? Tryk på Del-knappen, når du er færdig. Hvis du vil afslutte sessionen, tryk på Return.`,
